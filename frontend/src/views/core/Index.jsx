                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <h2 className="text-center d-block mt-1">What's Trending</h2>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row g-0">
                        <div className="col-12 ">
                            <div className="mb-4">
                                <h2 className="text-center">Find Your Vibe</h2>
                            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <h2 className="text-center d-block mt-1">Reader Favorites</h2>
                        </div>
                    </div>
                </div>
            </section>
